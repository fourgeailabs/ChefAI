...
- **"In The House Right Now" Smart Pantry Synthesis**: Real-time recipe formulation taking what the user has in their kitchen (with 1-tap common pantry staples like eggs, pasta, garlic, butter, canned tomatoes, cheese) and synthesizing iconic meals.
...
- **Smart Pantry & Shopping List**: One-tap ingredient import from any recipe, interactive check-off states, and custom grocery item additions.
...
### Current Version: `1.02.00` (Build 3) — September 03, 2026
